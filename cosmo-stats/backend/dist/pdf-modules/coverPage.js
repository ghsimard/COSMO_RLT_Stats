...
const generateCoverPage = (doc, school) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const rltLogoPath = path_1.default.join(__dirname, '..', '..', '..', 'public', 'images', 'RLT_logo.jpeg');
        const cltLogoPath = path_1.default.join(__dirname, '..', '..', '..', 'public', 'images', 'CLT_logo.jpeg');
